...
export const SEED_SPECIAL_PRICES: SpecialPrice[] = [
  {
    id: 'special-1',
    clientId: 'client-1', // Lucía Méndez
    serviceId: 'service-4', // Gel X Extensiones (Base: $1200)
    specialPrice: 4500, // Wait, Kapping/Gel X has special pricing of $4500. Let's make it match the visual: Esculpidas Gel-X Art: $4.500
    groupLabel: 'VIP DIAMANTE',
    isActive: true
  },
  {
    id: 'special-2',
    clientId: 'client-2', // Martina Rossi
    serviceId: 'service-2', // Soft Gel Extensión (Base: $650)
    specialPrice: 3200, // matches visual: Kapping + Soft Gel: $3.200
    groupLabel: 'AMIGA & FAMILIA',
    isActive: true
  },
  {
    id: 'special-3',
    clientId: 'client-3', // Sofía Castro
    serviceId: 'service-1', // Manicura Rusa (Base: $850)
    specialPrice: 1800, // matches visual: Esmaltado Semipermanente: $1.800
...
export const SEED_APPOINTMENTS: Appointment[] = [
  {
    id: 'appt-1',
    clientId: 'client-1', // Lucía Méndez
    serviceId: 'service-2', // Soft Gel (has base $650 or special)
    date: '2026-07-15', // Matches today's date
    time: '09:00',
    duration: 90,
    isHomeVisit: true,
    status: 'completed',
  ...
  {
    id: 'appt-2',
    clientId: 'client-8', // Carla Rivera
    serviceId: 'service-4', // Gel X
    date: '2026-07-15', // Matches today's date
    time: '11:30',
    duration: 120,
    isHomeVisit: false,
  ...
  {
    id: 'appt-3',
    clientId: 'client-4', // Valeria Castillo
    serviceId: 'service-5', // Nail Art Editorial ($1500)
    date: '2026-07-16', // Tomorrow
    time: '14:30',
    duration: 120,
    isHomeVisit: false,
    status: 'pending',
  ...
  {
    id: 'appt-4',
    clientId: 'client-5', // Mariana De la Rosa
    serviceId: 'service-1', // Manicura Rusa ($850)
    date: '2026-07-17',
    time: '16:00',
    duration: 60,
    isHomeVisit: false,
...
// High value seed movements for realistic charts
export const SEED_FINANCIALS: FinancialMovement[] = [
  ...
  // Incomes of June and July to reach $142,500 total incomes
  {
    id: 'move-6',
    type: 'income',
